...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "franka_fer_gripper":
        from .franka_fer_gripper import FrankaFERGripper

        return FrankaFERGripper(config)
    elif config.type == "mock_robot":
        from tests.mocks.mock_robot import MockRobot
    
    elif config.type == "franka_fer_robot":
        from lerobot.robots.franka_fer import FrankaFERRobot
        return FrankaFERRobot(config)

    elif config.type == "franka_fer_vr":
        from teleoperators.franka_fer_vr import FrankaFERVRTeleoperator
