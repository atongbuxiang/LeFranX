...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> Teleoperator:
    ...
    elif config.type == "franka_fer_spacemouse":
        from .franka_fer_spacemouse import FrankaFERSpaceMouseTeleoperator

        return FrankaFERSpaceMouseTeleoperator(config)
    elif config.type == "franka_fer_gripper_spacemouse":
        from .franka_fer_gripper_spacemouse import FrankaFERGripperSpaceMouseTeleoperator

        return FrankaFERGripperSpaceMouseTeleoperator(config)

    elif config.type == "sofranka":
        from .sofranka import SoFranka

        return SoFranka(config)
    elif config.type == "franka_fer_subarm":
        from .franka_fer_subarm import FrankaFERSubarmTeleoperator

        return FrankaFERSubarmTeleoperator(config)
    elif config.type == "franka_fer_gripper_subarm":
        from .franka_fer_gripper_subarm import FrankaFERGripperSubarmTeleoperator

        return FrankaFERGripperSubarmTeleoperator(config)
